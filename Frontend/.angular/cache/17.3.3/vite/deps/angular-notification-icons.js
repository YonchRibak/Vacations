...
// node_modules/angular-notification-icons/dist/angular-notification-icons.js
var require_angular_notification_icons = __commonJS({
  "node_modules/angular-notification-icons/dist/angular-notification-icons.js"(exports, module) {
    (function(root, factory) {
      if (typeof define === "function" && define.amd) {
        define(["angular"], factory);
      } else if (typeof exports === "object") {
        module.exports = factory(require_angular2());
      } else {
        root.returnExports = factory(root.angular);
      }
    })(exports, function(angular2) {
      "use strict";
      angular2.module("angular-notification-icons", ["angular-notification-icons.tpls"]);
      angular2.module("angular-notification-icons.tpls", []);
      angular2.module("angular-notification-icons.tpls").run(["$templateCache", function($templateCache) {
        $templateCache.put("template/notification-icon.html", '<div class="angular-notifications-container">\n    <div class="angular-notifications-icon overlay" ng-show="notification.visible"><div ng-hide="notification.hideCount">{{notification.count}}</div></div>\n    <div class="notification-inner">\n        <ng-transclude></ng-transclude>\n    </div>\n</div>');
      }]);
      "use strict";
      var NotificationDirectiveController = function($scope, $animate, $q) {
        ...
        self.getElement = function(element) {
          return angular2.element(element[0].querySelector(".angular-notifications-icon"));
        };
      ...
      angular2.module("angular-notification-icons").controller("NotificationDirectiveController", ["$scope", "$animate", "$q", NotificationDirectiveController]).directive("notificationIcon", notificationDirective);
      return { NotificationDirectiveController, notificationDirective };
    });
  }
});
export default require_angular_notification_icons();
...
angular/angular.js:
   ...
   *)
*/
//# sourceMappingURL=angular-notification-icons.js.map
